...
def setup(flags):
  ...
  if credentials is None:
    ...
    client_secrets = os.path.join(os.path.dirname(__file__),
                                  'client_secrets.json')
    '''
    client_secrets = "/Users/david/Box Sync/NYC Syzygy Data Team/Analytics/Data Warehouse Transition/ABG API Scripts_Python/DCM/client_secrets.json"
    storage = oauthFile.Storage("/Users/david/Box Sync/NYC Syzygy Data Team/Analytics/Data Warehouse Transition/ABG API Scripts_Python/DCM/dfareporting.dat")
    #storage = "/Users/david/Box Sync/NYC Syzygy Data Team/Analytics/Data Warehouse Transition/ABG API Scripts_Python/Scripts/dfareporting.dat"
